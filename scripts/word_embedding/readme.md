...
### [packages.txt](/scripts/word_embedding/python/packages.txt)
...
### [requirements.txt](/scripts/word_embedding/python/requirements.txt)
...
### [tokenizer_to_json.py](/scripts/word_embedding/python/tokenizer_to_json.py)
...
### [embedding.py](/scripts/word_embedding/python/embedding.py)
...
### [full_embedding_workflow.py](/scripts/word_embedding/python/full_embedding_workflow.py)

[tokenizer_to_json.py](/scripts/word_embedding/python/tokenizer_to_json.py) and [embedding.py](/scripts/word_embedding/embedding.py) combined and streamlined. For those who want to run everything in one fell swoop and don't care about saving intermediary data structures for outside use. Will save the word embedding model after creation.

## R

### [word2vec.R](/scripts/word_embedding/r/word2vec.R)

Script for R word embedding. There are also packages using gensimr, scikitlearn, and text2vec, but this is the only one that provides easy utility to export models for future use.
